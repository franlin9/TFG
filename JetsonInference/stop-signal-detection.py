...
def detener_y_avanzar():
    avanzar(3)        # Avanzar por 2 segundos
    detener(3)        # Detener por 3 segundos en la señal de stop
    avanzar(2)        # Avanzar nuevamente por 2 segundos
    print("Maniobra de detener y avanzar completada")
...
while True:
    ...
    for detection in detections:
        ...
        if label in desired_labels:
            ...
            print("Se ha encontrado una señal de stop")
            n = n + 1 ;
    if n == 1:
